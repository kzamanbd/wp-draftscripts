<div class="wrap">
    <div class="nav-tabs border-b border-gray-200 dark:border-gray-700">
        <ul class=" flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
            <li class="me-2">
                <button data-tw-target="home" data-tw-toggle="tab" type="button" class="active inline-flex items-center justify-center p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active dark:text-blue-500 dark:border-blue-500 group" aria-current="page">
            ...
            <li class="me-2">
                <button data-tw-target="profile" data-tw-toggle="tab" type="button" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
            ...
            <li class="me-2">
                <button type="button" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 group">
                    <svg class="w-4 h-4 me-2 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="tab-content">
            <?php settings_errors(); ?>
            <div class="tab-pane block active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="tab-pane hidden" id="profile" role="tabpanel" aria-labelledby="profile-tab">...</div>
            <div class="tab-pane hidden" id="contact" role="tabpanel" aria-labelledby="contact-tab">...</div>
        </div>
    </div>
